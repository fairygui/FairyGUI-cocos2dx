...
if (!cocos2d::Director::getInstance()->getScheduler()->isScheduled(schedule_selector(__TYPE__::__selector_##__FUNC__), this))\
    cocos2d::Director::getInstance()->getScheduler()->schedule(schedule_selector(__TYPE__::__selector_##__FUNC__), this, (__VA_ARGS__+0), false)

#define CALL_LATER_CANCEL(__TYPE__,__FUNC__) \
cocos2d::Director::getInstance()->getScheduler()->unschedule(schedule_selector(__TYPE__::__selector_##__FUNC__), this)

#define CALL_PER_FRAME(__TYPE__,__FUNC__) \
if (!cocos2d::Director::getInstance()->getScheduler()->isScheduled(schedule_selector(__TYPE__::__FUNC__), this))\
    cocos2d::Director::getInstance()->getScheduler()->schedule(schedule_selector(__TYPE__::__FUNC__), this, 0, false)
